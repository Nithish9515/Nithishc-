<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="adminlogin.aspx.cs" Inherits="opendirve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        ...
        ImageUrl="HOS/mgt.png" Height="252px" Width="278px" /></div>
    <div class="reg">
        <div class="title">
            Admin Login</div>
        <div class="left">
